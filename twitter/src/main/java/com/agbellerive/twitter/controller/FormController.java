...
private final static org.slf4j.Logger LOG = LoggerFactory.getLogger(FormController.class);
    ...
    /**
     * This method writes the file twitter4j.properties
     * according to the users input in the textfields
     * and it proceeds to write it to the root directory 
     * of the project
     * @param event 
     */
    @FXML
    ...
    /**
     * This method is to switch to the Twitter view
     * after the file is written to the proper directory 
     * by the method createFileClick
     */
