...
public class TweetViewController {
    ...
    /**
     * In the event the sendTweetBtn is clicked this method will be called and
     * if the requirements are met it will send the tweet with a method from the
    ...
    private void listenersSetUp() {
        ...
        sendTweetBtn.setOnAction(event -> {
            sendTweet();
        });
    }

    /**
     * This method changes the view of the labels depending on if it is called
     * by retweet or reply
     *
     * @param user
     * @param action
