...
public class MainApp extends Application {
    ...
    /**
     * This method creates the twitter view that is going to allow the twitter
     * functionality
     *
     * @return Scene
     * @throws Exception
    ...
    /**
     * This method creates the form that is going to be used to ask the user to
    ...
    /**
     * This method checks if the file twitter4j.properties exists if it doesn't
     * exist this method returns a false boolean which tells the start method to
     * redirect to the page to make the user enter information to create the
     * file
     *
     * @return boolean
     * @throws IOException
    ...
    /**
     * This method is for creating a pop up window when the user enters too many
     * characters for their tweet
     */
    ...
    /**
     * This method is fired up when there is an error like not being able to
     * send a tweet or send a direct message
     */
