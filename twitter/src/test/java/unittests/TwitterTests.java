...
public class TwitterTests {
    ...
    /**
     * This method is ran after all the tests are done cleaning out the database
     * for user use
     */
    @AfterClass
    @Ignore
    ...
    /**
     * This method tests that the database is completly empty so the size of the
    ...
    /**
     * This method inserts a single entry into the database so the database
    ...
    /**
     * On the SQL table the tweet id is the primary key so the user cannot save
     * the same tweet twice since the tweet id is unique to the specific tweet,
     * so this method needs to throw and error
     *
     * @throws java.sql.SQLException
     */
